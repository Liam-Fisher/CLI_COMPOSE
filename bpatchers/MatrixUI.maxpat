...
,
		"classnamespace" : "box",
		"rect" : [ 509.0, 266.0, 1951.0, 1265.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					"code" : "$spellCt = ($cts -> (\r\n$ctOctaves = int(floor(abs($cts/length(ActiveScale))))*sgn($cts);\r\n$ctIndices = ((abs($cts%length(ActiveScale))+length(ActiveScale))%length(ActiveScale))+1;\r\n#( make this tuning generic, eventually )#\r\npitch((ActiveScale:[$ctIndices])*100+$ctOctaves*1200)\r\n));\r\n\r\n$ind = 0;\r\n$totalDuration = 0;\r\n\r\nfor $rt $pos in ActiveRhythm do (\r\n    $totalDuration += abs($rt);\r\n    $slots _= ActiveSlotMatrix:$pos ||| [nil];\r\n    print(`rt $rt);\r\n    if $rt > 0 then (\r\n        print(`ind $ind);\r\n        $ind += 1;\r\n        $vc = ActiveVoicing::$ind + ((ActiveContour:$ind)-1);\r\n        print(`vc $vc);\r\n        $chords _= [ $spellCt($vc)+pitch(100*($x1-12)) ]\r\n    )\r\n    else (\r\n    $chords _= nil\r\n    )\r\n); \r\n$o1 = $totalDuration;\r\n$o2 = [ $chords ];\r\n$o3 = [ ActiveRhythm ];\r\n[`slots [$slots] ] ",
					"id" : "obj-1",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 672.893656849861145, 410.537666956583621, 273.0, 22.0 ],
					"saved_object_attributes" : 					{
						"embed" : 1,
						"versionnumber" : 80100
					}
,
					"text" : "bach.eval @file formatMotive.bell @extraoutlets 3"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 143.893656849861145, 289.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 74.982410788536072, 283.0, 150.0, 20.0 ],
					"text" : "Root: "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 641.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 789.231661975383759, 182.996803333759317, 29.5, 22.0 ],
					"text" : "0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 789.231661975383759, 216.704834392070779, 257.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
					"text" : "bach.value ActiveContour 0 11 3 -2 -8 @auto 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.231661975383759, 209.143352260589609, 79.0, 22.0 ],
					"text" : "[1 3 5] [1 3 5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.231661975383759, 235.899511864185342, 189.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 185.982410788536072, 543.578052024046542, 38.0, 22.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.982410788536072, 516.727171361446381, 61.0, 22.0 ],
					"text" : "t dump l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.982410788536072, 416.62521767616272, 74.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"outputmode" : 1,
					"patching_rect" : [ 143.982410788536072, 388.537666956583621, 50.0, 22.0 ],
					"text" : "0/1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.982410788536072, 490.727171361446381, 81.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1057.670935869216919, 144.089411964416513, 204.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
					"text" : "bach.value ActiveSlotMatrix @auto 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 151.578932523727417, 68.063884377479553, 204.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80100
									}
,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 152.470085322856903, 190.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 152.470085322856903, 162.431623220443726, 64.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80100
									}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "", "", "", "bang" ],
									"patching_rect" : [ 152.470085322856903, 127.564102590084076, 309.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80100
									}
,
									"text" : "bach.keys articulationinfo noteheadinfo slotinfo @keep 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "bang" ],
									"patching_rect" : [ 152.470136192226391, 99.890046656131744, 165.0, 22.0 ],
									"saved_object_attributes" : 									{
										"versionnumber" : 80100
									}
,
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"midpoints" : [ 161.970136192226391, 133.0, 161.970085322856903, 133.0 ],
									"source" : [ "obj-17", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 355.303418656190274, 152.17948704957962, 161.970085322856903, 152.17948704957962 ],
									"source" : [ "obj-23", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-29", 0 ],
									"midpoints" : [ 258.636751989523589, 151.034187912940979, 161.970085322856903, 151.034187912940979 ],
									"source" : [ "obj-23", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-29", 0 ],
									"midpoints" : [ 161.970085322856903, 152.0, 161.970085322856903, 152.0 ],
									"source" : [ "obj-23", 0 ]
								}
...
,
					"patching_rect" : [ 486.529419422149658, 489.44850093126297, 123.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"out" : "nnnnnnnn",
					"outlettype" : [ "", "", "", "", "", "", "", "", "bang" ],
					"patching_rect" : [ 182.632710337638855, 817.003115097681757, 526.0, 238.333333333333314 ],
					"pitcheditrange" : [ "null" ],
					"presentation" : 1,
					"presentation_rect" : [ 14.894724130630493, 15.196068445841433, 1027.0, 238.333333333333314 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 486.529419422149658, 448.44850093126297, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 374.893656849861145, 402.537666956583621, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 291.452994406223297, 35.897436261177063, 81.0, 22.0 ],
					"text" : "0 2 4 5 7 9 11"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 284.670935869216919, 131.796377718448639, 257.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
					"text" : "bach.value ActiveScale 0 2 4 5 7 9 11 @auto 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 550.231661975383759, 268.505275061130533, 69.0, 22.0 ],
					"text" : "1/4 -1/4 1/4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 247.893656849861145, 283.0, 192.0, 22.0 ],
					"saved_object_attributes" : 					{
						"versionnumber" : 80100
					}
,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 174.482410788536072, 618.384616553783417, 192.132710337638855, 618.384616553783417 ],
					"source" : [ "obj-166", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-80", 0 ],
					"midpoints" : [ 153.482410788536072, 621.035504400730133, 192.132710337638855, 621.035504400730133 ],
					"source" : [ "obj-166", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-80", 0 ],
					"midpoints" : [ 195.482410788536072, 587.384616553783417, 192.132710337638855, 587.384616553783417 ],
					"source" : [ "obj-177", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 384.393656849861145, 523.700856268405914, 214.482410788536072, 523.700856268405914 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-80", 0 ],
					"midpoints" : [ 496.029419422149658, 611.384616553783417, 192.132710337638855, 611.384616553783417 ],
					"source" : [ "obj-96", 0 ]
				}
